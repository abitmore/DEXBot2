...
**Version context:** v1.0.6 is the current release.
...
- **Coverage**: Historical milestones from the initial December 2025 bootstrap through the v1.0.6 stable release, including credit maintenance hardening
