...
**Version context:** v1.0.7 is the current release.
...
- **Coverage**: Historical milestones from the initial December 2025 bootstrap through the v1.0.7 stable release, including credit maintenance hardening
